...
const game = {
    ...
    generateOptionsShip(shipSize) {
        ...
        if (direction) {
            x = Math.floor(Math.random() * tabSize);
            y = Math.floor(Math.random() * (tabSize - shipSize));
        } else {
            x = Math.floor(Math.random() * (tabSize - shipSize));
            y = Math.floor(Math.random() * tabSize);
        };
        ...
        for (let i = 0; i < location.length; i++) {
            ...
            for(let j = startCoordX; j < startCoordX + 3; j++) {
                for (let z = startCoordY; z < startCoordY + 3; z++) {
                    if(j >= 0 && j < tabSize && z >= 0 && z < tabSize) {
                        const coord = j + '' + z;
